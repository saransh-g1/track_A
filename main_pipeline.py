"""
Main End-to-End Pipeline for Track A
Orchestrates all components: ingestion -> indexing -> decomposition -> retrieval -> reasoning -> aggregation
"""
...
class TrackAPipeline:
    ...
    def __init__(self, config: Optional[TrackAConfig] = None):
